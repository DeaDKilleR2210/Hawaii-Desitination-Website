            ...
            return(
                <div className="">
                    <div className="relative flex w-full bg-transparent h-103">
                        <div className="z-20 w-full bg-gradient-to-r from-yellow-300 via-yellow-200 to-transparent">
                    ...
                    <div className="relative flex w-full bg-transparent h-100">
                        ...
                        <div className="z-20 w-full bg-gradient-to-l from-yellow-300 via-yellow-200 to-transparent">
